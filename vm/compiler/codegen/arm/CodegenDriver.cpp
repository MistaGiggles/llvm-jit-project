...
bool dvmCompilerDoWork(CompilerWorkOrder *work)
{
    ...
    // Work out the name of the file that stores the name of the application
    char cmdlineFileName[32] = {0};
    sprintf(cmdlineFileName, "/proc/%d/cmdline", gDvmJit.pid);

    // Open the file, and read its contents into appName.
    FILE *cmdlineFileHandle = fopen(cmdlineFileName, "r");
