...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/llvm/include

#LOCAL_LDLIBS :=  -llog -g -lstdc++
LOCAL_LDFLAGS := -lLLVMAsmParser -lLLVMInstrumentation -lLLVMLinker -lLLVMArchive -lLLVMBitReader  -lLLVMJIT -lLLVMipo -lLLVMVectorize -lLLVMBitWriter  -lLLVMARMDisassembler -lLLVMARMAsmParser -lLLVMARMCodeGen -lLLVMARMDesc -lLLVMARMInfo -lLLVMARMAsmPrinter -lLLVMSelectionDAG -lLLVMAsmPrinter -lLLVMMCDisassembler -lLLVMMCParser -lLLVMInterpreter -lLLVMCodeGen -lLLVMScalarOpts -lLLVMInstCombine -lLLVMTransformUtils -lLLVMipa -lLLVMAnalysis -lLLVMMCJIT -lLLVMRuntimeDyld -lLLVMExecutionEngine -lLLVMTarget -lLLVMMC -lLLVMObject -lLLVMCore -lLLVMSupport


#LOCAL_STATIC_LIBRARIES +=  libLLVMAsmParser libLLVMInstrumentation libLLVMLinker libLLVMArchive libLLVMBitReader libLLVMDebugInfo libLLVMJIT libLLVMipo libLLVMVectorize libLLVMBitWriter libLLVMTableGen libLLVMIntelJITEvents libLLVMOProfileJIT libLLVMCppBackendCodeGen libLLVMCppBackendInfo libLLVMARMDisassembler libLLVMARMAsmParser libLLVMARMCodeGen libLLVMARMDesc libLLVMARMInfo libLLVMARMAsmPrinter libLLVMSelectionDAG libLLVMAsmPrinter libgtest_main libgtest libLLVMMCDisassembler libLLVMMCParser libLLVMInterpreter libLLVMCodeGen libLLVMScalarOpts libLLVMInstCombine libLLVMTransformUtils libLLVMipa libLLVMAnalysis libLLVMMCJIT libLLVMRuntimeDyld libLLVMExecutionEngine libLLVMTarget libLLVMMC libLLVMObject libLLVMCore libLLVMSupport


#LOCAL_WHOLE_STATIC_LIBRARIES := gnustl_static -lgtest_main -lgtest
